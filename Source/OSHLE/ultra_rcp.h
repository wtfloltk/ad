...
#define VI_CLOCK_MULTI .75

#define VI_NTSC_CLOCK		(VI_CLOCK_MULTI * 97363624)
#define VI_PAL_CLOCK		(VI_CLOCK_MULTI * 99313060)
#define VI_MPAL_CLOCK		(VI_CLOCK_MULTI * 97256632)
